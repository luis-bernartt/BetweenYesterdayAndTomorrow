...
init -2:
    ...
    style say_window:
        background Frame("gui/paper_bg.png", 40, 40)
        padding (100, 35)
        xalign 0.5
        yalign 0.9
        yoffset -30
    ...
    style sicredi_button_text:
        ...
        insensitive_color "#8f8a7f"
        insensitive_outlines [(1, "#ffffffaa", 0, 0)]
